...
public final class FragmentOpenDoor extends Fragment implements
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CommunicationAsyncTask communicationAsyncTask =
                        new CommunicationAsyncTask(getActivity(), Constantes.OPEN_DOOR, getRow() + 1);
                try {
    ...
    public void onTimerFinished(View view) {
        ...
        mConfirmationView.setImageResource(R.drawable.ic_open_door);
